...
link = pd.read_csv(r'C:\Users\eduar\OneDrive\Desktop\DEV\Football\PremierLeague\links.csv')
...
data_inicio = datetime.strptime('2024-12-02', '%Y-%m-%d')
...
if dataframes:
    ...
    df_final.to_csv(r'C:\Users\eduar\OneDrive\Desktop\DEV\Football\PremierLeague\database_temp.csv', index=False)
else:
